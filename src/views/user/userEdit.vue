<template>
  <div class="container">
    <div class="content-heading text-center">
      <h1 v-if="!id && checkIfAdmin()">Add User</h1>
      <h1 v-if="!id && !checkIfAdmin()">Register User</h1>
    ...
    <form class="jumbotron jumbotron-fluid">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4" v-if="checkIfAdmin()">
...
<script>
  ...
  import authService from "../../components/Common/CommonCall";
  export default {
    name: "user",
    data() {
      return {
        ...
        if (this.errors.length === 0) {
          if (!this.id) {
            if(this.checkIfAdmin()){
              ...
              userDataService.registerUser(this.user).then(() => {
                this.$router.push({name: "login", params: { msg: "registered" }});
              });
            }
          }
